...
@implementation LBCocoaSecurity
...
{
    LBCocoaSecurityResult * sha = [self sha384:key];
...
{
    LBCocoaSecurityDecoder *decoder = [LBCocoaSecurityDecoder new];
...
+ (LBCocoaSecurityResult *)aesEncryptWithData:(NSData *)data key:(NSData *)key iv:(NSData *)iv
{
    ...
    if (cryptStatus == kCCSuccess) {
        LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:buffer length:encryptedSize];
        free(buffer);
...
+ (LBCocoaSecurityResult *)md5WithData:(NSData *)hashData
{
    ...
    LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:digest length:CC_MD5_DIGEST_LENGTH];
    free(digest);
...
+ (LBCocoaSecurityResult *)sha1WithData:(NSData *)hashData
{
    ...
    LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA1_DIGEST_LENGTH];
    free(digest);
...
+ (LBCocoaSecurityResult *)sha224WithData:(NSData *)hashData
{
    ...
    LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA224_DIGEST_LENGTH];
    free(digest);
...
+ (LBCocoaSecurityResult *)sha256WithData:(NSData *)hashData
{
    ...
    LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA256_DIGEST_LENGTH];
    free(digest);
...
+ (LBCocoaSecurityResult *)sha384WithData:(NSData *)hashData
{
    ...
    LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA384_DIGEST_LENGTH];
    free(digest);
...
+ (LBCocoaSecurityResult *)sha512WithData:(NSData *)hashData
{
    ...
    LBCocoaSecurityResult *result = [[LBCocoaSecurityResult alloc] initWithBytes:digest length:CC_SHA512_DIGEST_LENGTH];
    free(digest);
...
@implementation LBCocoaSecurityResult
...
// convert LBCocoaSecurityResult to UTF8 string
- (NSString *)utf8String
{
...
#pragma mark HEX
// convert LBCocoaSecurityResult to HEX string
- (NSString *)hex
{
...
#pragma mark Base64
// convert LBCocoaSecurityResult to Base64 string
- (NSString *)base64
{
    LBCocoaSecurityEncoder *encoder = [LBCocoaSecurityEncoder new];
...
@implementation LBCocoaSecurityEncoder

// convert NSData to Base64
- (NSString *)base64:(NSData *)data
{
    return [data lb_base64EncodedString];
}
...
@implementation LBCocoaSecurityDecoder
- (NSData *)base64:(NSString *)string
{
    return [NSData lb_dataWithBase64EncodedString:string];
}
